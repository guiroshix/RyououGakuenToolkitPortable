...
main(void)
{
    ...
    if (result != RGT_SUCCESS) {
        // printf("FAAILED TO LOAD EBOOT");
        goto finish;
    }

    result = patch_union(eboot);
    if (result != RGT_SUCCESS) {
        print("PATCH UNION FAIL");
        goto finish;
    }

    result = patch_pr();
    if (result != RGT_SUCCESS) {
        print("PATCH_PR FAIL", result);
        goto finish;
    }

    result = patch_scripts(eboot);
    if (result != RGT_SUCCESS) {
        print("PATCH_SCRIPTS FAIL");
        goto finish;
    }
    ...
    if (result != RGT_SUCCESS)
    { print("FAILED TO REPLACE PARAM.SFO"); goto finish; }
    ...
    if (result != RGT_SUCCESS) 
    { print("FAILED TO REPLACE LT.BIN"); goto finish; }
    ...
    if (result != RGT_SUCCESS) 
    { print("FAILED TO REPLACE SC.CPK"); goto finish; }
    ...
    if (result != RGT_SUCCESS)
    { print("FAILED TO REPLACE UNION.CPK"); goto finish; }
    ...
    if (result != RGT_SUCCESS)
    { print("FAILED TO REPLACE PR.BIN"); goto finish; }
    ...
    if (result != RGT_SUCCESS)
    { print("FAILED TO REPLACE OP.PMF); goto finish; }
    ...
    if (result != RGT_SUCCESS) 
    { print("FALHA EM titlein.pmf. Codigo: %d\n", result); goto finish; }
    ...
    if (result != RGT_SUCCESS)
    { print("FALHA EM ed.pmf. Codigo: %d\n", result); goto finish; }
    ...
    if (result != RGT_SUCCESS)
    { print("FALHA EM mov_10.pmf. Codigo: %d\n", result); goto finish; }
    ...
    if (result != RGT_SUCCESS) { print("FALHA EM mov_11.pmf. Codigo: %d\n", result); goto finish; }
    ...
    if (result != RGT_SUCCESS)
    { print("FALHA EM mov_09.pmf. Codigo: %d\n", result); goto finish; }
